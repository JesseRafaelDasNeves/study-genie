...
[https://example/iassist/api/latest/completions](https://example/iassist/api/latest/completions)
...
```jsx
curl --location 'https://example//authentication/actions/loginWithKey' \
